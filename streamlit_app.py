...
text_vision: str = "Eine intuitive Webapplikation, die den Trennungsprozess vereinfacht – auch mobil. Mit benutzerfreundlichen Eingabemasken und klaren Erklärungen zur Barunterhaltsberechnung, unterstützt durch verständliche Visualisierungen. Ein KI-gestützter Trennungsvereinbarungs-Generator hilft, ohne juristische Vorkenntnisse, eine faire Vereinbarung zu erstellen. Ziel: Emotionen aus der Diskussion nehmen und den Trennungsprozess sachlich und fair gestalten, für ein gutes Nebeneinander nach der Trennung."
...
text_dank: str = "Vielen Dank für deine Unterstützung. Du hilfst mir hier bei meinem Herzensprojekt: Ich will faire und verständliche Trennungsvereinbarungen für euch, für ein gutes Nebeneinander nach der Trennung! "
